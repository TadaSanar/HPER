...
fetch_file_date = '202203280444'#'202203252333'
...
if fetch_old_results == False:
    ...
    for i in range(n_repetitions):
        ...
        optimum, rounds, suggestion_df, compositions_input, degradation_input, BO_batch, materials, X_rounds, x_next, Y_step, X_step = hper_bo(
            n_rounds, all_starting_points[i], batch_size, acquisition_function, beta, no_plots = True, data_fusion_property = data_fusion_property)
