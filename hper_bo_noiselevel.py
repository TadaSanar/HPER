...
def df_data_coll_param_builder(df_method=None, gradient_param=None, 
    ...
    if df_method is None:
        ...
        if df_method.find('model') != -1:
            ...
            use_model = False
            # The use has not really been implemented.
            # TO DO: propagate noise level to the acquisition function to set
            # exact_feval for data fusion model.
            noise = None
    ...
    if k == 0:
        ...
        if noise_level == 0:
            ...
            data_fusion_z_next = predict_points_noisy(
                data_fusion_gt_model, np.array(init_points),
        ...
        if data_fusion_x_next[k-1].empty is False:
            ...
            if noise_level == 0:
                ...
                data_fusion_z_next = predict_points_noisy(
                    data_fusion_gt_model, data_fusion_x_next[k-1].values,
                    noise_level = noise_level, seed = seed)[0]
    ...
    for k in range(rounds):
        ...
        if (function == True):
            ...
            X_rounds, Y_rounds, X_accum, Y_accum = query_target_data_from_model(
                ...
                stability_model, rounds, materials, noise_level = noise_target,
                seed = seed)
